...
//        notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
    ...
    private void showNotification(IncomingCallMessage incomingCallMessage, int notificationId) {
        ...
        if (!incomingCallMessage.isCancelled()) {
             ...
             */
            Intent intent = new Intent(this, TwilioVoiceModule.class);
            intent.setAction(TwilioVoiceModule.ACTION_INCOMING_CALL);
            intent.putExtra(TwilioVoiceModule.INCOMING_CALL_MESSAGE, incomingCallMessage);
            intent.putExtra(TwilioVoiceModule.INCOMING_CALL_NOTIFICATION_ID, notificationId);
