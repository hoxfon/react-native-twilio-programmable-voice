...
//  TwilioVoice.m
//
//  Created by Erva on 3/20/17.
//  Copyright © 2017 Erva. All rights reserved.
//
...
@interface TwilioVoice () <PKPushRegistryDelegate, TVONotificationDelegate, TVOCallDelegate, CXProviderDelegate>
...
{
  return @[@"connectionDidConnect", @"connectionDidDisconnect", @"callRejected"];
}
...
- (void)callDidConnect:(TVOCall *)call {
  ...
  [callParams setObject:call.callSid forKey:@"CallSid"];
  if(call.from){
...
- (void)callDidDisconnect:(TVOCall *)call {
  ...
  [self sendEventWithName:@"connectionDidDisconnect" body:@"connectionDidDisconnect"];
}
